...
const Reviews = () => {
    ...
    return (
        <div className="lg:my-20">
            <h1 className=" text-center  mt-10 font-bold lg:text-5xl text-3xl mb-10">
                What <span className="text-[#0360F9]">Our Member's</span> Saying About Us
            </h1>
            <div ref={sliderRef} className="keen-slider">
                <div className="flex justify-around lg:px-48 pt-10 pb-10  ">
                    {Reviews.map((review) => (
                        <div key={review.name}>
                            <div className="container flex flex-col keen-slider__slide mx-auto divide-y rounded-md cursor-pointer">
