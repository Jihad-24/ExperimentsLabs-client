...
const Footer = () => {
    return (
        ...
        <footer className="bg-gray-800 text-white py-12">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-24">
                <div>
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-2">ExperimentsLabs</h3>
